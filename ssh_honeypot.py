...
server_key = base_dir / 'honeysnare' / 'server.key'
...
funnel_handler = RotatingFileHandler('ssh_audits.log', maxBytes=2000, backupCount=5)
...
creds_handler = RotatingFileHandler('cred_audits.log', maxBytes=2000, backupCount=5)
